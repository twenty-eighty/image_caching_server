...
ENV CACHE_DIR=/cache
ENV PHX_SERVER=true
ENV MAGICK_MEMORY_LIMIT=64MB
ENV MAGICK_MAP_LIMIT=64MB
ENV MAGICK_DISK_LIMIT=256MB
ENV MAGICK_AREA_LIMIT=16MP
ENV MAGICK_WIDTH_LIMIT=8192
ENV MAGICK_HEIGHT_LIMIT=8192
ENV MAGICK_THREAD_LIMIT=1
ENV MAGICK_TIME_LIMIT=15
ENV MAX_CONCURRENT_IMAGE_OPS=1
ENV MAX_DOWNLOAD_MB=10
